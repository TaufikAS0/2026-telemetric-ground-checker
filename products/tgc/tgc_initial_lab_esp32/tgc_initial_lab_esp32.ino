...
// TGC — Telemetric Ground Checker — Initial LAB firmware, classic ESP32
// build target.
//
// Scope guard: this sketch implements the universal Telemetric Device
// Bootstrap flow (provisioning, discovery, OTA) for the ONE LAB build target
// TGC_LAB_ESP32_4M (classic ESP32 / 4MB / dio / partition scheme tgc-ota-4mb).
// This is a BUILD TARGET package (owner decision 2026-09-04): NO physical
// board has been verified for it, and it must never be flashed onto a board
// whose read-only chip detection does not answer as classic ESP32 with 4MB
// flash. It is not a universal BIN and makes no claim about other hardware
// or other profiles; it reuses no bootloader, partition table, or BIN from
// any other TGC build. The factory Wi-Fi value is the owner-approved PUBLIC
// LAB default (generated from src/config/factory-wifi.mjs); production
// profiles must inject secrets instead — the generated header's static_assert
// blocks this sketch outside the LAB.
//
...
static const char *const kHardwareRevision = "TGC_LAB_ESP32_4M";
static const char *const kPartitionScheme = "tgc-ota-4mb";
